...
const Icon = ({
  ...
  return (
    ...
    >
      <div
        className={`icon-div w-[12vw] h-[12vw] max-w-20 max-h-20 flex justify-center items-center p-3 sm:p-4 md:p-5 rounded-full text-slate-50 transition-[background] ease-in-out duration-300  ${
